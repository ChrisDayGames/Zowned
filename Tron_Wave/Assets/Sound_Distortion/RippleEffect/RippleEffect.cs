...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
		...
		public void Create(Vector2 screenPosition)
		{
			position = new Vector2(screenPosition.x/Screen.width, screenPosition.y/Screen.height);
			time = 0;
		}
...
//        }
		...
		if (Input.GetMouseButtonDown (0)) {
			EmitAtPosition (Input.mousePosition);
		}
	...
	public void EmitAtPosition(Vector2 screenPos)
	{
